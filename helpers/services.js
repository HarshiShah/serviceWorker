  ...
  */
  switch (process.env.NODE_ENV) {
    ...
    case 'production': {
      ...
      distServerPatternPrefix = 'https:\\/\\/teja8.kuikr.com\\/services\\/';
      break;
    }
    case 'stage': {
      nodeServerPatternPrefix = '^https:\\/\\/www.quikr.com\\/';
  ...
  returnObj.apis = 'https:\\/\\/www.quikr.com\\/services\\/api\\/qc\\/services\\/v1\\/sme\\/view\\/listing';
...
const servicesPages = [
  {
    pattern: new RegExp(`${nodeServerPatternPrefix}services`),
  },
];

const pattern = {
  strategy: servicesStrategies,
  pages: servicesPages,
};
